<?php
/* Smarty version 4.3.1, created on 2023-05-19 02:24:30
  from '/home/marco/public_html/E-lectronics/Smarty/templates/cart.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6466c1bed9c7f5_71528701',
...
function content_6466c1bed9c7f5_71528701 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
						...
						<table class="cart-table">
							...
							<tbody>
								<tr class="table-body-row">
									...
									<td class="product-image"><img src="Smarty/images/products/product-img-1.jpg" alt=""></td>
								...
								<tr class="table-body-row">
									<td class="product-remove"><a href="#"><i class="far fa-window-close"></i></a></td>
									<td class="product-image"><img src="Smarty/images/products/product-img-2.jpg" alt=""></td>
								...
								<tr class="table-body-row">
									<td class="product-remove"><a href="#"><i class="far fa-window-close"></i></a></td>
									<td class="product-image"><img src="Smarty/images/products/product-img-3.jpg" alt=""></td>
